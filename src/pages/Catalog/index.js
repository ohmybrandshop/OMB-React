			...
			<div className="catalog-page-holder">
				...
				<div className="categories-holder" style={{ marginBottom: 15 }}>
					...
					<div className="categories-slider-holder">
						<Slider className="categories-slider" {...catagoriesSliderSettings}>
							<div className="categories-content">
								<img src="/images/new-category.png" />
								<span className="category-text">New In</span>
							</div>
							<div className="categories-content">
								<img src="/images/kids.png" />
								<span className="category-text">Kids</span>
							</div>
							<div className="categories-content">
								<img src="/images/winter-category.png" />
								<span className="category-text">Winter</span>
							</div>
							<div className="categories-content">
								<img src="/images/outlet-category.png" />
								<span className="category-text">Pets</span>
							</div>
							<div className="categories-content">
								<img className="last-image" src="/images/summer.png" />
				...
				<div className="filter-section-holder">
					<div className="filter-btn-holder">
						...
						<span className="filter-text" onClick={() => {
                            toggleFilterMenu()
                        }}>Filter</span>
					</div>
